...
const showIssues = () => {
  ...
  totalIssueCount.innerHTML = issues.length;
  const remainingIssueCount = document.getElementById('remaining-issues');
  ...
  remainingIssueCount.innerHTML = countOpenIssues;
}
